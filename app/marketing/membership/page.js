          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
                <div className="w-14 h-14 bg-[#94de61]/20 rounded-xl flex items-center justify-center mb-6">
                  <svg className="w-7 h-7 text-[#5fa336]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <a
                  ...
                  className="bg-[#5fa336] text-white p-6 rounded-2xl hover:bg-[#487d2c] transition-colors flex items-center justify-center space-x-3"
                >
                  ...
                  <div className="text-left">
                    ...
                    <div className="text-white/80">Join discussions and get updates</div>
                  </div>
                </a>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-[#94de61] text-gray-900 p-6 rounded-2xl hover:bg-[#7bc94a] transition-colors flex items-center justify-center space-x-3"
                >
                  <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="text-left">
                    ...
                    <div className="text-gray-700">Get announcements and updates</div>
                  </div>
                </a>
              </div>
            </div>
