    ...
    const { data, error } = await resend.emails.send({
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <h2 style="color: #10b981;">Welcome to Eben Institute!</h2>
          <p>Hello ${name || 'there'},</p>
          <p>Thank you for joining our waitlist. We're excited to have you on board!</p>
          <p>Please verify your email address by clicking the button below:</p>
          <div style="text-align: center; margin: 30px 0;">
            <a href="${verificationLink}" style="background-color: #10b981; color: white; padding: 12px 24px; text-decoration: none; border-radius: 5px; font-weight: bold;">
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <div style="background-color: #f3f4f6; padding: 20px; border-radius: 8px; margin: 25px 0;">
            ...
            <p>
              <a href="https://t.me/ebeninstitute" style="color: #10b981;">🔗 Telegram Community</a><br>
              <a href="https://whatsapp.com/channel/ebeninstitute" style="color: #10b981;">🔗 WhatsApp Channel</a>
            </p>
          </div>
          ...
          <p style="color: #6b7280; font-size: 14px;">
            ...
            <a href="https://ebeninstitute.org" style="color: #10b981;">ebeninstitute.org</a>
          </p>
        </div>
      `
    })
